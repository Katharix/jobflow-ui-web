...
@Component({
  ...
  standalone: true,
  imports: [RouterOutlet, PublicNavbarComponent, PublicFooterComponent, BackToTopComponent, PreloaderComponent, HeroComponent, PricingComponent, FeaturesComponent, CtaComponent, ContactComponent],
