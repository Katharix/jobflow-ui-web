...
import { PriceBookCategoryService, PriceBookCategoryDto, CreatePriceBookCategoryRequest, UpdatePriceBookCategoryRequest } from './services/price-book-category.service';
import { OrganizationContextService } from '../../services/shared/organization-context.service';
import { OrganizationDto } from '../../models/organization';
import { ModalService } from '../../common/modal/modal.service';
import { AddEditCategoryData, AddEditCategoryResult, AddEditPriceBookCategoryDialogComponent } from './add-edit-pricebook-category-dialog/add-edit-pricebook-category-dialog.component';
...
export class PriceBookComponent implements OnInit {
  ...
  private loadCategories(): void {
    ...
    this.priceBookCategoryService.getAll(this.organizationId!).subscribe({
      next: (cats) => {
  ...
  onAddCategory(): void {
    ...
    this.priceBookCategoryService.create(this.organizationId!, body).subscribe({
      next: (created) => {
  ...
  editCategory(category: PriceBookCategoryDto): void {
    ...
    this.priceBookCategoryService.update(this.organizationId!, category.id, body).subscribe({
      next: (updated) => {
  ...
  deleteCategory(category: PriceBookCategoryDto): void {
    // Confirm in real UI
    this.priceBookCategoryService.delete(this.organizationId!, category.id).subscribe({
      next: () => {
  ...
  openAddMaterialDialog(): void {
    ...
    ref.afterClosed().subscribe(result => {
      ...
      this.priceBookCategoryService.create(this.organizationId, {
        name: result.name,
